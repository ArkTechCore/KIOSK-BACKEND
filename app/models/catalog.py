...
class CatalogProduct(Base):
    ...
    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    category_id: Mapped[str] = mapped_column(String(64), ForeignKey("catalog_categories.id"), index=True)
...
class CatalogModifierGroup(Base):
    ...
    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    product_id: Mapped[str] = mapped_column(String(64), ForeignKey("catalog_products.id"), index=True)
...
class CatalogModifierOption(Base):
    ...
    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    group_id: Mapped[str] = mapped_column(String(64), ForeignKey("catalog_modifier_groups.id"), index=True)
